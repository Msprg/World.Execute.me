...
\033[0m"""
        for karakter in obj:
            print(karakter,end="",flush=True)
        # listx = ["     ██ 39%","     ███ 49%","     ████ 76%","     █████ 89%","     ██████ 100%","     ██████  GENERATING DATA","     ██████      GENERATING OBJECTS","     ██████            GENERATING FUNCTIONS","     ██████                  COLLECTING DATA   ","     ██████                      STARTING RPC SESSION ","     ██████                        CONNECTING TO SERVER..........   ","     ██████                          CONNECTING TO SERVER..............DONE!","     ██████           L A U N C H I N G    T H E     S I M U L A T I O N               "]
        listx = [
         "     ██ 39%                                                                               ",
         "     ███ 49%                                                                              ",
         "     ████ 76%                                                                             ",
         ...
         "     ██████                   COLLECTING DATA                                             ",
         "     ██████                        STARTING RPC SESSION                                   ",
         "     ██████                             CONNECTING TO SERVER..........                    ",
         "     ██████                             CONNECTING TO SERVER..............DONE!           ",
         "     ██████              L A U N C H I N G    T H E     S I M U L A T I O N               "]
        count = 0
        for c in listx:
            if count != len(listx):
                sys.stdout.write('\r' + c)
