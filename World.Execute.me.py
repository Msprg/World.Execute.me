        ...
        if data["setOfPoint"] != "":
            ...
            if data["Circle"] == len(data["setOfPoint"]):
                ...
                if len(data["sineWave"]) == 11:
                    ...
                    World.slow_print(style.RED+"infinity"+style.RESET,0.02 )
                    # sys.stdout.write("\n\n")
                    # sys.stdout.flush()
                    data["im"] = "INFINITY"
                    if data["im"] == "INFINITY":
                        ...
                        if data["me"] == 666:
                            ...
                            data["you"].append("ROOT PERMISSION DENIED")
                        print("\n\n::: Your ::: ")
...
trapz.join()
World.slow_print(style.RED+"\n      We are trapped\n"+style.RESET,0.0015)
World.slow_print(style.RED+"\naaaaaaaaAAAAAAAAAH!!!"+style.RESET,0.06)

World.slow_print(style.BLUE+"\n\nI've studied"+style.RESET,0.005)
time.sleep(0.3)
World.slow_print(style.BLUE+" I've studied"+style.RESET,0.005)
time.sleep(0.3)
World.slow_print(style.BLUE+"\nHow to properly "+style.RESET,0.02)
World.slow_print(style.BLUE+"L - O - O - O - V E"+style.RESET,0.033)
World.slow_print(style.RED+"\nQuestion me"+style.RESET,0.01)
time.sleep(0.4)
World.slow_print(style.RED+" Question me"+style.RESET,0.01)
time.sleep(0.4)
World.slow_print(style.RED+"\nI can answer all "+style.RESET,0.02)
World.slow_print(style.RED+"L - O - O - O - V E"+style.RESET,0.033)
